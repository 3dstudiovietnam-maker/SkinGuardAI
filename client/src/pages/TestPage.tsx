    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        >
          ...
          <p className="text-slate-500 text-sm">{t("test.subtitle")}</p>
        </motion.div>
        ...
        >
          ...
          <Link href="/test/capture">
            <div className="p-5 bg-cyan-50 border border-cyan-200 rounded-2xl hover:bg-cyan-100 transition-colors cursor-pointer group">
              ...
              <p className="font-semibold text-slate-800 text-sm mb-1">{t("test.tryOwnPhoto")}</p>
              <p className="text-xs text-slate-500">{t("test.uploadPhoto")}</p>
          ...
          <Link href="/test/knowledge">
            <div className="p-5 bg-violet-50 border border-violet-200 rounded-2xl hover:bg-violet-100 transition-colors cursor-pointer group">
              ...
              <p className="font-semibold text-slate-800 text-sm mb-1">{t("test.knowledgeBase")}</p>
              <p className="text-xs text-slate-500">{t("test.abcdTitle")}</p>
          ...
          <Link href="/test/doctors">
            <div className="p-5 bg-emerald-50 border border-emerald-200 rounded-2xl hover:bg-emerald-100 transition-colors cursor-pointer group">
              ...
              <p className="font-semibold text-slate-800 text-sm mb-1">{t("test.doctorsNearby")}</p>
              <p className="text-xs text-slate-500">{t("test.findDoctors")}</p>
